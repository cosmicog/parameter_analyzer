...
int main ( int argc, char** argv )
{
	...
	ros::param::get("parameter_analyzer/param_start", LASER_HIT);
	ros::param::get("parameter_analyzer/laser_z_rand", LASER_RND);
	ros::param::get("parameter_analyzer/param_end", PARAM_END);
	
	ros::param::set("/amcl/laser_z_hit", LASER_HIT);
	ros::param::set("/amcl/laser_z_rand", LASER_RND);
...
{
	ROS_INFO("-------------------------------");
	ros::param::get("/amcl/laser_z_hit", LASER_HIT);
	ROS_INFO("-- laser_z_hit: %lf", LASER_HIT);
	ros::param::get("/amcl/laser_z_rand", LASER_RND);
	ROS_INFO("-- laser_z_rand: %lf", LASER_RND);
	ROS_INFO("-------------------------------\n");
...
{
	LASER_HIT = config.laser_z_hit;
	LASER_RND = config.laser_z_rand;
}
