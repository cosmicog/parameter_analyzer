...
int main ( int argc, char** argv )
{
	...
	ros::param::get("parameter_analyzer/param_start", ODOM_ALPHA1);
	ros::param::get("parameter_analyzer/odom_alpha2", ODOM_ALPHA2);
	ros::param::get("parameter_analyzer/param_end", PARAM_END);
	
	ros::param::set("/amcl/odom_alpha1", ODOM_ALPHA1);
	ros::param::set("/amcl/odom_alpha2", ODOM_ALPHA2);
...
{
	ROS_INFO("-------------------------------");
	ros::param::get("/amcl/odom_alpha1", ODOM_ALPHA1);
	ROS_INFO("-- odom_alpha1: %lf", ODOM_ALPHA1);
	ros::param::get("/amcl/odom_alpha2", ODOM_ALPHA2);
	ROS_INFO("-- odom_alpha2: %lf", ODOM_ALPHA2);
	ROS_INFO("-------------------------------\n");
...
{
	ODOM_ALPHA1 = config.odom_alpha1;
	ODOM_ALPHA2 = config.odom_alpha2;
}
