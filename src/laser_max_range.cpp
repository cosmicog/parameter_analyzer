...
int main ( int argc, char** argv )
{
	...
	ros::param::get("parameter_analyzer/param_start", LASER_MAX_RANGE);
	ros::param::get("parameter_analyzer/param_end", PARAM_END);
	ros::param::set("/amcl/laser_max_range", LASER_MAX_RANGE);
...
{
	ROS_INFO("-------------------------------");
	ros::param::get("/amcl/laser_max_range", LASER_MAX_RANGE);
	ROS_INFO("-- laser_max_range: %lf", LASER_MAX_RANGE);
	ROS_INFO("-------------------------------\n");
...
{
	LASER_MAX_RANGE = config.laser_max_range;
}
