...
int main ( int argc, char** argv )
{
	...
	ros::param::get("parameter_analyzer/param_start", UPDATE_MIN_D);
	ros::param::get("parameter_analyzer/param_end", PARAM_END);
	ros::param::set("/amcl/update_min_d", UPDATE_MIN_D);
...
{
	ROS_INFO("-------------------------------");
	ros::param::get("/amcl/update_min_d", UPDATE_MIN_D);
	ROS_INFO("-- update_min_d: %lf", UPDATE_MIN_D);
	ROS_INFO("-------------------------------\n");
