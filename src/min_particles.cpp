...
int main ( int argc, char** argv )
{
	...
	ros::param::get("parameter_analyzer/param_start", MIN_PARTICLES);
	ros::param::get("parameter_analyzer/param_end", PARAM_END);
	ros::param::set("/amcl/min_particles", MIN_PARTICLES);
...
{
	ROS_INFO("-------------------------------");
	ros::param::get("/amcl/min_particles", MIN_PARTICLES);
	ROS_INFO("-- min_particles: %d", MIN_PARTICLES);
	ROS_INFO("-------------------------------\n");
